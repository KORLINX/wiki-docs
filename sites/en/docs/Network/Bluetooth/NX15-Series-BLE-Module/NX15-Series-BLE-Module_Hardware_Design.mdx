...
:::note
This page does not cover antenna layout in detail. For chip antenna keep-out and u.FL RF trace design, see [NX15 Antenna Design](./NX15-Series-BLE-Module_Antenna_Design).
:::
...
| Topic | Go To |
| --- | --- |
| Chip antenna keep-out and u.FL RF trace | [NX15 Antenna Design](./NX15-Series-BLE-Module_Antenna_Design) |
| Sleep current and firmware power tuning | [NX15 Low Power Guide](./NX15-Series-BLE-Module_Low_Power_Guide) |
| BLE advertising and GATT services | [NX15 BLE Application Guide](./NX15-Series-BLE-Module_BLE_Application_Guide) |
