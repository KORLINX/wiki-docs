...
:::note
This page focuses only on antenna layout. Power, GPIO, SWD, reset, and general PCB design are covered in [NX15 Hardware Design](./NX15_Hardware_Design).
:::
...
| Topic | Go To |
| --- | --- |
| Power, GPIO, SWD, reset | [NX15 Hardware Design](./NX15_Hardware_Design) |
| First firmware bring-up | [NX15 Quick Start](./NX15_Quick_Start) |
| BLE advertising / GATT behavior | [NX15 BLE Application Guide](./NX15_BLE_Application_Guide) |
| Low-power firmware tuning | [NX15 Low Power Guide](./NX15_Low_Power_Guide) |
