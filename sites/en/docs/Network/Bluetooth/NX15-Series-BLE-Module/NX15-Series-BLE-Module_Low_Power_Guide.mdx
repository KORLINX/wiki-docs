...
:::note
This page focuses on firmware-level low-power strategy. Power supply, decoupling, and PCB hardware design are covered in [NX15 Hardware Design](./NX15-Series-BLE-Module_Hardware_Design).
:::
...
| Topic | Go To |
| --- | --- |
| VDD, GND, SWD, reset | [NX15 Hardware Design](./NX15-Series-BLE-Module_Hardware_Design) |
| Antenna keep-out / u.FL trace | [NX15 Antenna Design](./NX15-Series-BLE-Module_Antenna_Design) |
| First BLE bring-up | [NX15 Quick Start](./NX15-Series-BLE-Module_Quick_Start) |
| BLE services and application data | [NX15 BLE Application Guide](./NX15-Series-BLE-Module_BLE_Application_Guide) |
