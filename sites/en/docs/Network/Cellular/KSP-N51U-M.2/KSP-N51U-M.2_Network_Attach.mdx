---
sidebar_position: 13
title: KSP-N51U-M.2 Network Attach
description: How the KSP-N51U-M.2 attaches to LTE-M / NB-IoT. It connects automatically by default — confirm attach, and set the system mode when you need LTE-M or NB-IoT specifically.
keywords: [KSP-N51U-M.2, network attach, Serial Modem, LTE-M, NB-IoT, XSYSTEMMODE, CEREG, APN, KORLINX]
---
...
:::tip
For registration error codes in depth, see the [FAQ](./KSP-N51U-M.2_FAQ).
:::
...
- [Quick Start](./KSP-N51U-M.2_Quick_Start) — hardware bring-up and first AT command
- [AT Commands](./KSP-N51U-M.2_Network_Attach) — full command reference
- [FAQ](./KSP-N51U-M.2_FAQ) — registration troubleshooting
